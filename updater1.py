...
class Updater:
    ...
    def upload_files_to_github(self, token: str, owner: str, repo: str, branch: str = "main"):
...
if __name__ == "__main__":
    # Пример: выгрузка на GitHub (раскомментируйте при необходимости)
    ...
    main()
    if GITHUB_TOKEN:
        updater.upload_files_to_github(
            token=GITHUB_TOKEN,
            owner="Latortsev",
            repo="LOA_LSO",
            branch="main"
